...
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_valid}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[0]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[1]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[2]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[3]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[4]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[5]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[6]}]
set_input_delay -clock [get_clocks CLK] -add_delay 2.5 [get_ports {in_image[7]}]
